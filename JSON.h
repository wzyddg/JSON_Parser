...
//own functions
extern JSON* newJSON();
extern JSON* stringParse(char* string,int length);
extern JSON* objectParse(char* value,unsigned long length);
extern JSON* arrayParse(char* value,unsigned long length);
extern void printArray(JSON* array,int superType);
extern void printObject(JSON* object,int superType);
extern void recursePrintToFile(FILE* file , JSON* item , int superType);
